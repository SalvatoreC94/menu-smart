...
import { primary, ghost } from '../../styles/utils'
...
export default function CreateMenuPage() {
  ...
  const close = () => navigate('/admin/dashboard')
                ...
                <span style={{
                  ...
                  {s.state === 'done' ? (
                    <svg width="9" height="9" viewBox="0 0 9 9" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M1 4.5L3.5 7 8 1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ) : s.i}
                </span>
                <div>
                  <div style={{
                    ...
                    color: s.state === 'todo' ? palette.muted : palette.ink,
                    lineHeight: 1.2,
                  }}>{s.label}</div>
                  <div style={{
                    fontSize: 10.5,
            ...
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  fontStyle: 'italic',
                  fontSize: 17,
                }}>Importa il menu da una foto</div>
                <div style={{
                  fontSize: 11.5,
                  color: palette.muted,
                  marginTop: 2,
