// MenuSmart sample data — ES module named exports

export const ph = (seed, label, hue = 30) =>
...
].map((d) => ({ ...d, ingredients: ingredientsMap[d.id] || [] }));

export const sections = [
  { id: 'antipasti', it: 'Antipasti',    en: 'Starters',      fr: 'Entrées',     de: 'Vorspeisen',    note: 'Per cominciare' },
  { id: 'primi',     it: 'Primi piatti', en: 'First courses', fr: 'Pâtes & riz', de: 'Erste Gänge',   note: 'Paste e risotti' },
  { id: 'secondi',   it: 'Secondi',      en: 'Mains',         fr: 'Plats',       de: 'Hauptgerichte', note: 'Dal mare e dalla terra' },
  { id: 'dolci',     it: 'Dolci',        en: 'Desserts',      fr: 'Desserts',    de: 'Nachspeisen',   note: 'Per concludere' },
];
