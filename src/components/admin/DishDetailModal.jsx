...
import { allergens, tags } from '../../data'

export default function DishDetailModal({ palette, dish, onClose }) {
            ...
            <div style={{ display: 'flex', gap: 4 }}>
              {[1, 0, 0].map((on, i) => (
                <span key={i} style={{
                  width: 16,
                  height: 2,
                  background: on ? '#fff' : 'rgba(255,255,255,.4)',
                }} />
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            <button style={{
              ...
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" strokeWidth="1.4">
                <path d="M2 2h7v4l3 1v6H2z M5 2v3h3" />
              </svg>
              Modifica piatto
            </button>
            <button
              onClick={() => { onClose(); navigate('/menu/cena?lang=it&variant=classic') }}
              style={{
                padding: '10px 14px',
                fontSize: 12.5,
                cursor: 'pointer',
              ...
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.4">
                ...
                <path d="M2 6h8M6 2c1.4 1.2 2 2.7 2 4s-.6 2.8-2 4M6 2C4.6 3.2 4 4.7 4 6s.6 2.8 2 4" />
              </svg>
              Anteprima cliente
            </button>
          </div>
